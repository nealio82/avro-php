...
class IODatumReader
{
     ...
     */
    public function __construct(Schema $writers_schema = null, Schema $readers_schema = null)
    {
     ...
     */
    public static function schemas_match(Schema $writers_schema, Schema $readers_schema)
    {
        ...
        if ($writers_schema_type == $readers_schema_type) {
            ...
            if (Schema::INT_TYPE == $writers_schema_type
                && in_array($readers_schema_type, [Schema::LONG_TYPE, Schema::FLOAT_TYPE, Schema::DOUBLE_TYPE])
            ) {
                return true;
            }

            if (Schema::LONG_TYPE == $writers_schema_type
                && in_array($readers_schema_type, [Schema::FLOAT_TYPE, Schema::DOUBLE_TYPE])
            ) {
                return true;
            }
     ...
     */
    public static function attributes_match(Schema $schema_one, Schema $schema_two, $attribute_names)
    {
     ...
     * @param Schema $readers_schema
     */
    public function set_writers_schema(Schema $readers_schema): void
    {
     ...
     * @param null|bool|int|float|string|array $default_value
     *
