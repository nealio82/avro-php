...
class RecordSchemaTest extends TestCase
{
    ...
    public function schemaExamplesProvider(): iterable
    {
        ...
        yield ['{"type": "record", "name": "Address", "fields": [{"type": "string"}, {"type": "string", "name": "City"}]}', false, null];
        ...
        yield ['{"name": ["Tom", "Jerry"], "type": "record", "fields": [{"name": "name", "type": "string"}]}', false, null];
